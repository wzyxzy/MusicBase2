...
public class SplashADActivity extends Activity implements SplashADListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      ...
      fetchSplashAD(this, container, skipView, Preferences.APPID, getPosId(), this, 0);
    }
  }
    ...
    handler.postDelayed(new Runnable() {
      ...
      public void run() {
        if (needStartDemoList) {
          SplashADActivity.this.startActivity(new Intent(SplashADActivity.this, LoginActivity.class));
        }
