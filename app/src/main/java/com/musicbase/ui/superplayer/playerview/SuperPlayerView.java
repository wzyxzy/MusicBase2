...
import com.musicbase.ui.superplayer.NetWatcher;
...
//    private TCDanmuView mDanmuView;
    ...
    private TXVideoConfig mTXVideoConfig;
...
//        addView(mDanmuView);
    ...
    private void playTimeShiftLiveURL(final SuperPlayerModel superPlayerModel) {
        ...
        mTXVideoConfig = new TXVideoConfig();
...
//            LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_LIVE_TIME, "", diff, "", null);
            mReportLiveStartTime = -1;
        }
        if (mReportVodStartTime != -1) {
            long reportEndTime = System.currentTimeMillis();
            long diff = (reportEndTime - mReportVodStartTime) / 1000;
//            LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_VOD_TIME, "", diff, "", null);
    ...
    private TCVodControllerBase.VodController mVodController = new TCVodControllerBase.VodController() {
        ...
        public void onRequestPlayMode(int requestPlayMode) {
            ...
            //请求悬浮窗模式
                ...
                // 悬浮窗上报
//                LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_FLOATMOE, "", 0, "", null);
            }
...
//                LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_TIMESHIFT, "", 0, "", null);
            }
...
//
        ...
        public void onQualitySelect(TCVideoQulity quality) {
            ...
            //清晰度上报
//            LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_CHANGE_RESOLUTION, "", 0, "", null);
        }
        ...
        public void onSpeedChange(float speedLevel) {
            ...
            //速度改变上报
//            LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_CHANGE_SPEED, "", 0, "", null);
        }
        ...
        public void onMirrorChange(boolean isMirror) {
            ...
            if (isMirror) {
                //镜像上报
//                LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_MIRROR, "", 0, "", null);
            }
        }
        ...
        public void onHWAcceleration(boolean isAccelerate) {
            ...
            // 硬件加速上报
//            if (isAccelerate) {
//                LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_HW_DECODE, "", 0, "", null);
//            } else {
//                LogReport.getInstance().uploadLogs(TCConstants.ELK_ACTION_SOFT_DECODE, "", 0, "", null);
//            }
        }
        ...
        public void onReplay() {
            if (!TextUtils.isEmpty(mCurrentSuperPlayerModel.videoURL)) {
                ...
                superPlayerModel.videoURL = mCurrentSuperPlayerModel.videoURL;
