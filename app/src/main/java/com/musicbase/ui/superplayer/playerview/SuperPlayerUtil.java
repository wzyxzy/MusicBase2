...
public class SuperPlayerUtil {
    ...
    public static TCVideoQulity convertToVideoQuality(TXPlayInfoStream sourceStream, String classification) {
        TCVideoQulity quality = new TCVideoQulity();
     ...
     * @return
     */
    public static TCVideoQulity convertToVideoQuality(TXPlayInfoStream stream) {
    ...
    public static ArrayList<TCVideoQulity> convertToVideoQualityList(HashMap<String, TXPlayInfoStream> transcodeList) {
