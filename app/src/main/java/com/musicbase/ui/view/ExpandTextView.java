    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isFirst) {
            ...
            mExpandText.post(new Runnable() {
                @Override
                public void run() {
//                    mEnd = (int) (mExpandText.getLineHeight()) * (int) (mExpandText.getLineCount() * 1.26);
                    mEnd = mExpandText.getLineHeight() * mExpandText.getLineCount();
//                    Logger.d("mEnd:" + mEnd + ",getLineHeight:" + mExpandText.getLineHeight() + ",getLineCount:" + mExpandText.getLineCount());
                }
            });
...
//                    Logger.d("start:" + mStart + ",end:" + mEnd + ",interpolatedTime:" + interpolatedTime);
                    setLayoutParams(params);
                }
            };
