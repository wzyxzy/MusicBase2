package com.musicbase.download2.thread;
...
import com.musicbase.download2.Utils.Global;
import com.musicbase.download2.Utils.Util;
...
//					mManager.downloadFailed(mContext,mDocInfo);

					/**
					 * 此处会崩溃，将来可判断下载失败直接删除或者暂停
					 */
