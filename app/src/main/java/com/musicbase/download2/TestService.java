package com.musicbase.download2;
...
public class TestService extends Service {
	...
	public void onCreate() {
		 ...
		 * });
		 */
		m.addDownloadListener(new DownloadManager.DownloadListener() {
			@Override
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		if (null != intent) {
			...
			if (null != bundle) {
				...
				String path = ActivityUtils.getSDPath(this,info.getBookId())
						.getAbsolutePath();
				info.setFilePath(path);
				m.startForActivity(this,info);
			}
		}
		return super.onStartCommand(intent, flags, startId);
	}
